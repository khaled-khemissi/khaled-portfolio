...
document.querySelectorAll('.skill-progress').forEach(bar => {
  ...
  const translations = {
    fr: {
        ...
        proj6Title: "Plugin de génération automatique de fichiers XML",
        proj6Desc: "Création d’un plugin permettant d’extraire des données spécifiques depuis une base de données et de les transformer en fichiers XML basés sur un modèle prédéfini. Ce plugin facilite l’automatisation des exports, l’échange de données et l’intégration avec des services externes.",
        proj7Title: "Fushia – Boutique en ligne WordPress & WooCommerce personnalisée",
        proj7Desc: "Boutique de mode WordPress & WooCommerce avec thème personnalisé et design responsive.",
         proj8Title: "Vibrance Parfum – Site E-Commerce",
    proj8Desc: "Plateforme e-commerce élégante et moderne pour Vibrance Parfum, marque française de parfums. Design responsive, gestion facile du catalogue, paiement en ligne sécurisé et navigation intuitive.",
    proj9Title: "TasteAura – Landing Page",
    proj9Desc: "Landing page personnalisée pour TasteAura, offrant une expérience culinaire immersive. Entièrement responsive, chargement rapide et design sur-mesure pour une UX optimale.",       
        educationTitle: "Éducation",
    ...
    en: {
        ...
        proj6Title: "Automatic XML File Generation Plugin",
        proj6Desc: "Developed a plugin that extracts specific data from a database and transforms it into XML files based on a predefined model. This plugin streamlines export automation, data exchange, and integration with external services.",
        proj7Title: "Fushia – Custom WordPress & WooCommerce Clothing Store",
        proj7Desc: "Custom WordPress & WooCommerce fashion store with a personalized theme and responsive design.",
          proj8Title: "Vibrance Parfum – E-Commerce Website",
    proj8Desc: "Elegant and modern e-commerce platform for Vibrance Parfum, a French perfume brand. Responsive design, easy catalog management, secure online payment, and intuitive navigation.",
    proj9Title: "TasteAura – Landing Page",
    proj9Desc: "Custom landing page for TasteAura, offering an immersive culinary experience. Fully responsive, fast-loading, and designed from scratch for optimal UX.",
